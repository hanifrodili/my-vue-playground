<template lang="pug">
.product-card()
  v-row.ma-0.my-row(style="align-content:center; padding: 16px 0 16px 0" @click="selectProduct(productIndex)")
    ...
    v-col.d-flex.pa-0.align-self-center.text-right(cols='3')
  ...
  v-row.ma-0.my-row(style="padding-bottom: 16px")
...
.my-row:nth-of-type(2),
.my-row:nth-of-type(3){
  width: 100%;
  height: 0;
  transition: height 0.2s ease-in-out;
}

.product-card.clicked .my-row{
  max-height: max-content;
  height: 100%;
}
</style>
